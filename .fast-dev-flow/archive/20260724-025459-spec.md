...
- [ ] AC1: at a normal widget width (inner >= ~100), the label column shows at least ~26 visible characters of a name (today it caps at ~14), so names like "Corvus Sessions" and "Telemetry_Ingestion_Navigation" are read in full or near-full.
